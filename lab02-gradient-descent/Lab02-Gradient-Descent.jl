...
$$h_i = \mathbf{x}_i^T W \Rightarrow \frac{\partial h_i}{\partial W} = ...$$

$$\hat{y}_i = \sigma(h_i) \Rightarrow \frac{\partial \hat{y}_i}{\partial h_i} = ...$$

$$loss_i = (\hat{y}_i - y_i)^2 \Rightarrow \frac{\partial loss_i}{\partial \hat{y}_i} = ...$$
...
$$\nabla Loss = \frac{\partial Loss(W)}{\partial W} =\frac{1}{n} \sum_{i=1}^n ...$$
