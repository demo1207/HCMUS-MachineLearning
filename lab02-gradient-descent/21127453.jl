...
begin
	...
	plt_2 = scatter(X_test'[1,:][y_test .== 0], X_test'[2,:][y_test .== 0], label="Class 0", color=:blue, legend=:topright, markersize=4) # assign to plt var
	...
	contour!(plt_2, xₘᵢₙ:0.1:xₘₐₓ, yₘᵢₙ:0.1:yₘₐₓ,
			(x, y) -> decision([x, y]),
...
julia_version = "1.9.3"
manifest_format = "2.0"
project_hash = "ec5549dd11a27e23a586bf37d5c00b5a8a538aff"
